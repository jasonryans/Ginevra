    ...
    <div class="max-w-xl mx-auto py-8">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="file" name="foto_product[]" multiple
                    class="file-input file-input-bordered w-full dark:text-gray-200" required>
           ...
           <div>
                <label class="block font-medium dark:text-gray-200">Feature <span class="text-sm text-gray-500">(Optional)</span></label>
                ...
                <div class="grid grid-cols-4 gap-3">
                    ...
                    @foreach ($availableSizes as $size)
                        <label class="flex items-center space-x-2 cursor-pointer">
                            ...
                            <span
                                class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ $size }}</span>
                        </label>
                    @endforeach
                </div>
            ...
            <a href="{{ route('admin.products.index') }}"
                class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded ml-2">Kembali</a>
        </form>
    </div>
