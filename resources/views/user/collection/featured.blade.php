...
@section('content')
    <div class="container mt-4">
        ...
        <div class="row" id="products-container">
            @if ($products->count() > 0)
                @include('user.collection.partials.product-grid', ['products' => $products])
            @else
                <div class="col-12">
        ...
        <div id="end-of-products" class="text-center my-4" style="display: none;">
            <p class="text-muted">You've reached the end of our featured products.</p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadMoreProducts() {
                ...
                let url = '/featured/paginate';
                if (featureType) {
                    url = `/featured/${featureType}/paginate`;
                }
